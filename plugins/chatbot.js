...
if (/^silvinha|silvia$/i.test(m.text) ) { //sin prefijo 
let teks = `${pickRandom([`*ta querendo oque com a mulher do meu dono?*`, `*cuidado que o big ta so de olho em pra tu tomar nao custa nada?*`])}`.trim()
