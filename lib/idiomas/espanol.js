...
const smsRowner = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝙴𝚄 𝙲𝙾𝙼𝙾 𝙲𝚁𝙴𝙰𝙳𝙾𝚁(𝙰) 𝙳𝙾 𝙱𝙾𝚃 𝙿𝙾𝙳𝙴 𝚄𝚂𝙰𝚁!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝙼𝙴𝚄 𝙲𝚁𝙸𝙰𝙳𝙾𝚁(𝙰) 𝙿𝙾𝙳𝙴 𝚄𝚂𝙰𝚁!!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝙰𝙳𝙼𝙸𝙽𝚂 𝙾𝚄 𝙼𝙴𝚄 𝙲𝚁𝙸𝙰𝙳𝙾𝚁(𝙰) 𝙿𝙾𝙳𝙴 𝚄𝚂𝙰𝚁!!\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝙴𝚂𝚃𝙰𝚁 𝙳𝙸𝚂𝙿𝙾𝙽𝙸́𝚅𝙴𝙻 𝙿𝙰𝚁𝙰 𝚄𝚂𝚄𝙰́𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝙴 𝙼𝙴𝚄 𝙲𝚁𝙸𝙰𝙳𝙾𝚁(𝙰)!! 𝙿𝙰𝚁𝙰 𝚂𝙴𝚁 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝙲𝙾𝙼𝙿𝚁𝙴 𝚄𝙼 𝙿𝙰𝚂𝙴 𝚄𝚂𝙰𝙽𝙳𝙾 #pass premium\`\`\`` }//USUARIOS PREMIUM
const smsGroup = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙼 𝙶𝚁𝚄𝙿𝙾𝚂!!\`\`\`` }//PARA GRUPOS
const smsPrivate = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚜𝚘́ 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙽𝙾 𝙿𝚁𝙸𝚅𝙰𝙳𝙾!!\`\`\`` }//AL PRIVADO
...
//MENU LISTA
const smsTime = () => { return `𝚃𝙴𝙽𝙿𝙾 𝙰𝚃𝚄𝙰𝙻`}
...
const smsResultPareja = () => { return `𝙽𝙰̃𝙾 𝚃𝙴𝙼 𝙼𝚄𝙻𝙷𝙴𝚁`}
...
const smsApagar = () => { return '❌ 𝙳𝙴𝚂𝙰𝚃𝙸𝚅𝙰𝚁'} 
const smsEncender = () => { return '✅ 𝙰𝚃𝙸𝚅𝙰𝚁'} 
...
//_antitoxic.js
const smsToxic1 = () => { return `𝙽𝙰̃𝙾!!! 🤬 𝙳𝙸𝚉𝙴𝚁 𝙴𝚂𝚃𝙰 𝙿𝙰𝙻𝙰𝚅𝚁𝙰`}
...
const smsLect2 = () => { return `*deixar mensagens ou bate-papos como lidas(o)*`}
